...
- (void)webViewDidFinishLoad:(UIWebView*)theWebView
{
    ...
    ILTranslucentView *translucentView = [[ILTranslucentView alloc] initWithFrame:CGRectMake(0, 0, theWebView.frame.size.width, 22)];
    
    translucentView.translucentAlpha = 0.8;
    translucentView.translucentStyle = UIBarStyleDefault;
    translucentView.translucentTintColor = [UIColor clearColor]; //[UIColor colorWithRed:241 green:241 blue:241 alpha:1];
